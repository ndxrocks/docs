...
<CardGroup cols={3}>
  <Card
    ...
    icon="user"
    href="https://github.com/kern-ai/kern/tree/main/cookbook/05_workflows/_06_advanced_basics/_04_shared_session_state/shared_session_state_with_agent.py"
  >
  ...
  <Card
    title="Team Examples"
    icon="users"
    href="https://github.com/kern-ai/kern/tree/main/cookbook/05_workflows/_06_advanced_basics/_04_shared_session_state/shared_session_state_with_team.py"
  >
