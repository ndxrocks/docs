...
```shell
uv pip install -U kern-ai sqlalchemy
...
<Card title="Database Context Provider" icon="database" href="https://github.com/kern-ai/kern/blob/main/cookbook/12_context/04_database_read_write.py">
