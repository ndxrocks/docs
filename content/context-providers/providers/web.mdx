...
<Tabs>
  ...
  <Tab title="Parallel">
    ...
    ```python
    from kern.context.web import WebContextProvider, ParallelBackend
  ...
  <Tab title="Parallel MCP">
    ...
    ```python
    from kern.context.web import WebContextProvider, ParallelMCPBackend
...
<CardGroup cols={2}>
  ...
  <Card title="Cookbook Example" icon="book" href="https://github.com/kern-ai/kern/blob/main/cookbook/12_context/web.py">
    Working example
  </Card>
</CardGroup>
