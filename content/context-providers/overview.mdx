...
```python
from kern.context.fs import FilesystemContextProvider
from kern.context.web import WebContextProvider, ExaMCPBackend
from kern.context.database import DatabaseContextProvider
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="box-open"
    iconType="duotone"
    href="/context-providers/providers/overview"
  >
...
<CardGroup cols={2}>
  <Card title="Cookbook Examples" icon="book" href="https://github.com/kern-ai/kern/tree/main/cookbook/12_context">
