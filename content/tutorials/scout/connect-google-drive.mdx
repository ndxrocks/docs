...
The full setup, including the manual GCP Console path for orgs that block service-account keys, lives in the Scout repo: [GDRIVE_CONNECT.md](https://github.com/kern-agi/scout/blob/main/docs/GDRIVE_CONNECT.md).
...
For more, see [GDRIVE_CONNECT.md](https://github.com/kern-agi/scout/blob/main/docs/GDRIVE_CONNECT.md).
