...
Kern gives you four templates: one foundational, three production.
...
| Looking for a kitchen-sink with every Kern feature                   | [Demo OS](/demo-os/overview)                              |
...
Or browse the [Demo OS reference](/demo-os/overview) for the kitchen-sink view of every Kern feature.
