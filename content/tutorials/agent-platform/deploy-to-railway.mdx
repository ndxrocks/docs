...
The default path is to let [os.kern.ndx.rocks](https://os.kern.ndx.rocks) generate the keypair for you.

<Steps>
  <Step title="Add the OS in os.kern.ndx.rocks">
...
You don't have to use os.kern.ndx.rocks. Generate your own RSA or EC keypair, sign tokens with the private key in your own service, and put the matching public key in `JWT_VERIFICATION_KEY`. The platform doesn't care where the key came from as long as incoming tokens verify.
