...
2. **What tools does it need?** Pick from Kern's [100+ toolkits](/tools/toolkits/overview) or describe a custom tool.
...
Open [os.kern.ndx.rocks](https://os.kern.ndx.rocks), select your new agent in the sidebar, and try realistic prompts. Run it through:
