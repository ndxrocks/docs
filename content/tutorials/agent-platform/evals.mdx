...
Results write to Postgres via `eval_db`. Eval history shows up at [os.kern.ndx.rocks](https://os.kern.ndx.rocks) alongside your sessions and traces, so you can see when a case started failing and what changed.
