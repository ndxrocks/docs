...
The [Injector agent](https://github.com/kern-agi/demo-os/blob/main/agents/injector/agent.py) shows how to give an agent access to runtime configuration without baking it into the prompt or the tool definitions.
...
Source: [`agents/injector/agent.py`](https://github.com/kern-agi/demo-os/blob/main/agents/injector/agent.py)
