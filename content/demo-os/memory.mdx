...
The [Contacts agent](https://github.com/kern-agi/demo-os/blob/main/agents/contacts/agent.py) is a mini CRM that remembers people, the facts you tell it about them, who knows whom, and what's happening between them.
...
Source: [`agents/contacts/agent.py`](https://github.com/kern-agi/demo-os/blob/main/agents/contacts/agent.py), [Learning Machine docs](/learning/overview)
