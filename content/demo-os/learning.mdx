...
|-------|----------------|
| [Dash](https://github.com/kern-agi/demo-os/tree/main/agents/dash) | Schema gotchas, validated query patterns, error fixes that worked |
| [Contacts](https://github.com/kern-agi/demo-os/tree/main/agents/contacts) | People, relationships, events, your communication preferences |
| [Investment](https://github.com/kern-agi/demo-os/tree/main/teams/investment) | Past investment decisions, framework refinements, pattern recognition |
...
```python
from kern.learn import LearnedKnowledgeConfig, LearningMode
...
Source: [`agents/contacts/`](https://github.com/kern-agi/demo-os/tree/main/agents/contacts), [`agents/dash/`](https://github.com/kern-agi/demo-os/tree/main/agents/dash), [Learning docs](/learning/overview)
