...
```python
from kern.embedder.openai import OpenAIEmbedder
from kern.knowledge.chunking.text import TextChunkingStrategy
...
Source: [`agents/dash/`](https://github.com/kern-agi/demo-os/tree/main/agents/dash), [Knowledge docs](/knowledge/overview)
