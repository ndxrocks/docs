...
| Agent | What it shows |
|-------|---------------|
| [**Helpdesk**](https://github.com/kern-agi/demo-os/blob/main/agents/helpdesk/agent.py) | All three pause patterns + PII + injection guardrails + audit hook |
| [**Approvals**](https://github.com/kern-agi/demo-os/blob/main/agents/approvals/agent.py) | The `@approval` decorator with audit trail |
| [**Feedback**](https://github.com/kern-agi/demo-os/blob/main/agents/feedback/agent.py) | `UserFeedbackTools` and `UserControlFlowTools` for structured questions |

## Helpdesk: the full HITL toolkit

```python
from kern.agent import Agent
from kern.guardrails import OpenAIModerationGuardrail, PIIDetectionGuardrail, PromptInjectionGuardrail
from kern.tools.user_feedback import UserFeedbackTools
...
from kern.approval.decorator import approval
...
```python
from kern.tools.user_feedback import UserFeedbackTools, UserControlFlowTools
...
```python
from kern.guardrails import PIIDetectionGuardrail, PromptInjectionGuardrail
...
For audit logs that shouldn't gate the response, use `@hook(run_in_background=True)`. See [Human-in-the-Loop](/features/human-approval) for the full pattern.
...
Sources: [`agents/helpdesk/`](https://github.com/kern-agi/demo-os/tree/main/agents/helpdesk), [`agents/approvals/`](https://github.com/kern-agi/demo-os/tree/main/agents/approvals), [`agents/feedback/`](https://github.com/kern-agi/demo-os/tree/main/agents/feedback)
