...
<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.2.12" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.2.12">v2.2.12</Tooltip>
</Badge>
...
Kern provides a rich set of filter expressions that can be combined to create sophisticated search criteria:
...
```python
from kern.filters import GT, LT
...
```python
from kern.filters import AND, EQ
...
```python
from kern.filters import OR, EQ
...
```python
from kern.filters import NOT, EQ
...
from kern.filters import EQ, IN, AND
...
```python
from kern.filters import AND, OR, NOT, EQ, IN, GT
...
from kern.agent import Agent
from kern.filters import IN, AND, NOT, EQ
...
from kern.filters import AND, NOT, EQ, GT
...
```python
from kern.filters import AND, EQ, GT
...
<AccordionGroup>
  ...
  <Accordion title="Check filter structure">
    ...
    ```python
    from kern.filters import EQ, GT, AND
