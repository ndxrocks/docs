...
from kern.knowledge.reader.llms_txt_reader import LLMsTxtReader
...
knowledge.insert(
    url="https://kern.ndx.rocks/llms.txt",
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U beautifulsoup4 sqlalchemy psycopg pgvector kern-ai openai
    ```
  </Step>
