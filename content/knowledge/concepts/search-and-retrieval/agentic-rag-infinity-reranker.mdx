...
Run: uv pip install kern-ai anthropic infinity-client lancedb
...
from kern.knowledge.reranker import InfinityReranker
...
asyncio.run(
    knowledge.insert_many(
        urls=[
            "https://kern.ndx.rocks/introduction/agents.md",
            "https://kern.ndx.rocks/agents/tools.md",
            "https://kern.ndx.rocks/agents/knowledge.md",
        ]
    )
)
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai anthropic infinity-client lancedb "infinity-emb[all]"
    ```
  </Step>
