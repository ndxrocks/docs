...
<Steps>
    ...
    knowledge.insert(
        ...
        reader=PDFReader(
            ...
            chunking_strategy=SemanticChunking(
                embedder=embedder,  # Use same Kern embedder for chunking
                chunk_size=500,
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai sqlalchemy psycopg pgvector chonkie openai
    ```
  </Step>
