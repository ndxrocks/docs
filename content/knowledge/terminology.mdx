...
description: Essential concepts and terminology for understanding how Knowledge works in Kern agents.
---

This reference guide defines the key concepts and terminology commonly encountered when working with Knowledge in Kern.
...
await knowledge.ainsert(path="large_dataset/")
