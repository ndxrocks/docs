...
from kern.vectordb.llamaindex import LlamaIndexVectorDb
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U llama-index-core llama-index-readers-file llama-index-embeddings-openai pypdf openai kern-ai
    ```
  </Step>
