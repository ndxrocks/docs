...
<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.2.7" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.2.7">v2.2.7</Tooltip>
</Badge>

You can use Redis as a vector database with Kern.
