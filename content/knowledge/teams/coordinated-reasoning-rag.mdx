...
Setup:
1. Run: `uv pip install kern-ai anthropic cohere lancedb tantivy sqlalchemy`
...
async def async_reasoning_demo():
    ...
    await knowledge.ainsert_many(urls=["https://kern.ndx.rocks/introduction/agents.md"])
...
def sync_reasoning_demo():
    ...
    # Add documentation content
    knowledge.insert_many(urls=["https://kern.ndx.rocks/introduction/agents.md"])
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        uv pip install kern-ai cohere lancedb tantivy sqlalchemy
        ```
    </Step>
