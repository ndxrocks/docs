...
Setup:
1. Run: `uv pip install openai lancedb tantivy pypdf sqlalchemy kern-ai`
...
from kern.utils.print_response.team import aprint_response, print_response
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        uv pip install kern-ai openai lancedb tantivy pypdf sqlalchemy cohere
        ```
    </Step>
