...
Setup:
1. Install dependencies: `uv pip install kern-ai anthropic infinity-client lancedb`
...
from kern.knowledge.reranker.infinity import InfinityReranker
...
async def async_distributed_search():
    ...
    await knowledge_primary.ainsert_many(
        urls=["https://kern.ndx.rocks/introduction/agents.md"]
    )
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        uv pip install kern-ai cohere lancedb "infinity-emb[all]"
        ```
    </Step>
