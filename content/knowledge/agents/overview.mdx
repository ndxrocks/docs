...
description: Understanding knowledge and how to use it with Kern agents
...
This data is best displayed on the [knowledge page of the AgentOS UI](https://os.kern.ndx.rocks/knowledge).
...
- View [Cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/08_knowledge/)
