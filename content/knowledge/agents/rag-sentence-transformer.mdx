...
Run: `pip install kern-ai sentence-transformers`
...
from kern.knowledge.reranker import SentenceTransformerReranker
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai sentence-transformers sqlalchemy psycopg pgvector
    ```
  </Step>
