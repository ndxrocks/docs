...
description: Use local JSON files for simple session storage.
---
...
- View [Cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/07_database/json/json_for_agent.py)