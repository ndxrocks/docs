---
title: PostgreSQL
description: Use PostgreSQL for session storage and persistence.
sidebarTitle: Overview
---

Kern supports using [PostgreSQL](https://www.postgresql.org/) as a database with the `PostgresDb` class.
...
- View [Cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/07_database/postgres/postgres_for_agent.py)
