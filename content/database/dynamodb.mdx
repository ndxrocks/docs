---
title: DynamoDB
description: Use DynamoDB for session storage and persistence.
sidebarTitle: Overview
---

Kern supports using [DynamoDB](https://aws.amazon.com/dynamodb/) as a database with the `DynamoDb` class.
...
- View [Cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/07_database/dynamodb/dynamo_for_agent.py)
