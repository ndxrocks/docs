---
title: MySQL
description: Use MySQL for session storage and persistence.
sidebarTitle: Overview
---

Kern supports using [MySQL](https://www.mysql.com/) as a database with the `MySQLDb` class.
...
- View [Cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/07_database/mysql/mysql_for_agent.py)
