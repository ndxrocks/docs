...
description: Use Google Cloud Storage for JSON-based session storage.
---

Kern supports using [Google Cloud Storage (GCS)](https://cloud.google.com/storage) as a database with the `GcsJsonDb` class.
...
- View [Cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/07_database/gcs/gcs_json_for_agent.py)
- see full example [here](/database/providers/gcs/usage/gcs-for-agent)