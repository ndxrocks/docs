...
Kern supports using [MySQL](https://www.mysql.com/) asynchronously, with the `AsyncMySQLDb` class.
...
Run `uv pip install openai sqlalchemy asyncmy kern-ai` to install dependencies.
"""
