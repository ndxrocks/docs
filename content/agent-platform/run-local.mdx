...
<Steps>
  <Step title="Clone the template">
    ```bash
    git clone https://github.com/kern-agi/agent-platform-railway.git agent-platform
    cd agent-platform
    ```
...
AgentOS also comes with a UI at [os.kern.ndx.rocks](https://os.kern.ndx.rocks).

## Connect the AgentOS UI

1. Open [os.kern.ndx.rocks](https://os.kern.ndx.rocks) and log in.
