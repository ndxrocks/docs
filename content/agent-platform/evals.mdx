...
Results are stored in your database via `eval_db` (visible at [os.kern.ndx.rocks](https://os.kern.ndx.rocks)).
...
Results write to Postgres via `eval_db`. You can view the Eval history on [os.kern.ndx.rocks](https://os.kern.ndx.rocks) alongside your sessions and traces. You can see when a case started failing and what changed.
