...
The `InfraSettings` object in the `infra/settings.py` file defines common settings used by your Kern Infra apps and resources.

## Build your development image

Your application uses the `kern` docker images by default. To use your own image:
