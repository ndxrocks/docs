...
The template includes agents you can extend with Claude Code:
...
```bash
uv pip install -U 'kern-ai[infra]'
```
...
<Tip>
Or clone directly: `git clone https://github.com/kern-agi/agentos-aws-template.git`
</Tip>
...
<Warning>
  ...
  to os.kern.ndx.rocks. You'll set this up after deployment.
</Warning>
...
<CardGroup cols={3}>
  <Card title="Configure" icon="gear" href="/deploy/templates/aws/configure/infra-settings">
    Region, subnets, and ECR
  </Card>
  <Card title="Connect" icon="key" href="/deploy/templates/aws/go-live/connect">
    Run your agents in the cloud
  </Card>
  <Card title="Verify" icon="check" href="/deploy/templates/aws/go-live/verify">
