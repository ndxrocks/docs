...
### Connecting to Kern A2A Servers

```python
from kern.team import RemoteTeam

# Connect to an Kern AgentOS with A2A interface
team = RemoteTeam(
...
|----------|--------------|----------|
| `"agentos"` | N/A | Default. Connect to Kern AgentOS REST API |
...
```python
from kern.team import RemoteTeam
from kern.run.team import RunContentEvent, RunCompletedEvent
