...
The `MigrationManager` class provides a programmatic way to manage database schema migrations for Kern database tables.
...
- [Migration Scripts](https://github.com/kern-ai/kern/tree/main/libs/kern/migrations)
