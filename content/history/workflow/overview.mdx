...
<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.1.4" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.1.4">v2.1.4</Tooltip>
</Badge>

Workflow History enables your Kern workflows to remember and reference previous conversations, transforming isolated executions into continuous, context-aware interactions. 
