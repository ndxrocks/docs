...
<Tip>
Want to visualize your sessions? Check out the [AgentOS UI sessions page](https://os.kern.ndx.rocks/sessions) for a beautiful interface to view and manage all your conversation threads.
</Tip>
