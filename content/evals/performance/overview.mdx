...
"""Run `uv pip install kern-ai openai memory_profiler` to install dependencies."""
...
"""Run `uv pip install openai kern-ai` to install dependencies."""
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai memory_profiler
    ```
  </Step>
...
<Steps>
  ...
  Head over to <a href="https://os.kern.ndx.rocks/evaluation">https://os.kern.ndx.rocks/evaluation</a> to view the evals.
  </Step>
</Steps>
