---
title: Tracing
description: Gain deep visibility into your Kern agents with OpenTelemetry-based observability
sidebarTitle: Overview
keywords: [tracing, observability, opentelemetry, debugging, monitoring]
---

<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.3.5" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.3.5">v2.3.5</Tooltip>
</Badge>

In the systems you build with Kern, agents will make autonomous decisions, interact with external tools, and coordinate with each other in ways that aren't immediately visible from your recorded sessions alone. Observability is key to staying on top of what your agents are doing and how your system is performing.

**Kern Tracing** is the recommended way to introduce observability for your Kern agents, teams, and workflows. 
...
Tracing leverages [OpenTelemetry](https://opentelemetry.io/) to instrument the Kern agents and teams, capturing traces and spans.
...
As your Kern system become more complex (Agents using multiple tools, making sequential decisions, and coordinating with other agents), understanding its behavior becomes challenging. 

**Kern Tracing** solves this:
...
<Note>
All Kern Tracing data is stored in your own database. No tracing data will leave your system, or be sent to third parties: you are in complete control.
</Note>
...
- **Database Storage**: Traces stored in your Kern database (SQLite, PostgreSQL, etc.)
...
<Steps>
  <Step title="Install Dependencies">
    ```bash
    uv pip install -U opentelemetry-api opentelemetry-sdk openinference-instrumentation-kern-ai
    ```
  </Step>
