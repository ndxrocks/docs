---
title: Basic Setup
description: Configure and enable tracing for your Kern agents
keywords: [tracing, setup, configuration, database, opentelemetry]
---

This guide walks you through setting up tracing for your Kern agents. Tracing is designed to be simple: install dependencies, enable tracing, and all your agents are automatically instrumented.
...
<Note>
  These packages provide the OpenTelemetry instrumentation infrastructure and the Kern-specific instrumentation logic.
</Note>

## Two Ways to Enable Tracing

There are two ways to enable tracing in Kern:
...
Kern supports two trace processing modes:
