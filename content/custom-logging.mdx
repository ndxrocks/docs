...
description: Configure custom loggers and formatters for your Kern setup.
...
# Configure Kern to use the custom logger
...
# Configure Kern to use the file logger
configure_agno_logging(custom_default_logger=custom_logger)
...
# Kern will automatically detect and use these loggers
agent = Agent()
