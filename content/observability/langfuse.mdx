---
title: Langfuse
description: Integrate Kern with Langfuse to send traces and gain insights into your agent's performance.
---
...
1. **Install Dependencies**
   ...
   ```bash
   uv pip install kern-ai openai langfuse opentelemetry-sdk opentelemetry-exporter-otlp openinference-instrumentation-kern-ai
   ```
