---
title: Weave
description: Integrate Kern with Weave by WandB to send traces and gain insights into your agent's performance.
---

## Integrating Kern with Weave by WandB

[Weave by Weights & Biases (WandB)](https://weave-docs.wandb.ai/) provides a powerful platform for logging and visualizing model calls. By integrating Kern with Weave, you can track and analyze your agent's performance and behavior.
