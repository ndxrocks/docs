---
title: LangSmith
description: Integrate Kern with LangSmith to send traces and gain insights into your agent's performance.
---
...
3. **Install Dependencies**
   ...
   ```bash
   uv pip install openai openinference-instrumentation-kern-ai opentelemetry-sdk opentelemetry-exporter-otlp
   ```
