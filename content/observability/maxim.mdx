---
title: Maxim
description: Connect Kern with Maxim to monitor, trace, and evaluate your agent's activity and performance.
---
...
1. **Install Dependencies**
   ...
   ```bash
   uv pip install kern-ai openai maxim-py
   ```
