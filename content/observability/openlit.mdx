---
title: OpenLIT
description: Integrate Kern with OpenLIT for OpenTelemetry-native observability, tracing, and monitoring of your AI agents.
---
...
1. **Install Dependencies**
   ...
   ```bash
   uv pip install kern-ai openai openlit
   ```
