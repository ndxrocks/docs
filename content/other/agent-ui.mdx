...
keywords: [agent ui, agentui, agent interface, self-hosted ui, kern ui]
---
...
```bash
git clone https://github.com/kern-agi/agent-ui.git
```
...
<Steps>
  ...
  <Step title="Install dependencies">
    ...
    <CodeGroup>
    ```bash Mac
    uv pip install -U openai ddgs yfinance sqlalchemy 'fastapi[standard]' kern-ai
    ```
