...
description: Migrate Kern database tables between versions.
---

You can expect the schemas in your Kern database tables to be stable across versions.
...
from kern.db.migrations import MigrationManager
...
You can find the supporting scripts to handle your migration needs in the [`libs/kern/migrations`](https://github.com/kern-ai/kern/tree/main/libs/kern/migrations) directory.
...
<Tabs>
  ...
  <Tab title="Invalid Column Errors">
    Ensure you have run the migration before using the updated `kern` code in production.
  </Tab>
...
## Migrating from Kern v1 to v2

If you started using Kern during its v1 and want to move to v2, we have a migration script that can help you update your database tables.

You can find the script in the [`libs/kern/migrations/v1_to_v2/migrate_to_v2.py`](https://github.com/kern-ai/kern/blob/main/libs/kern/migrations/v1_to_v2/migrate_to_v2.py) file.

You can find more information about migrating from v1 to v2 in the [Migrating to Kern v2 guide](/other/v2-migration).