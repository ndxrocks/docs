...
title: Router HITL
sidebarTitle: Router
description: Select routes, confirm routing decisions, or review router output before continuing.
keywords: [workflow, router, HITL, route selection, confirmation, output review, human review, branching]
---
...
from kern.workflow.types import HumanReview, StepInput, StepOutput
...
Set a deadline for user responses during router HITL pauses. See the dedicated [Timeout](/workflows/hitl/timeout) page for full details.
