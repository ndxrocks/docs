...
| `on_timeout` | `OnTimeout` | `None` | Action when timeout expires. See [Timeout](/workflows/hitl/timeout) |
...
from kern.workflow import Workflow, OnReject
from kern.workflow.step import Step
from kern.workflow.types import HumanReview, StepOutput
from kern.db.sqlite import SqliteDb
...
- [Cookbooks](https://github.com/kern-ai/kern/tree/main/cookbook/04_workflows/08_human_in_the_loop/output_review)
