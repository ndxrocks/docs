...
> **Tip:** For a more information about using Scenario with Kern, check out the [Scenario documentation](https://github.com/langwatch/scenario/blob/main/docs/docs/pages/agent-integration/kern.mdx).
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U openai kern-ai langwatch-scenario pytest pytest-asyncio
    # or
    uv add kern-ai langwatch-scenario openai pytest
    ```
  </Step>
