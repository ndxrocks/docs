...
If you see a request for an OpenAI API key but haven't explicitly configured OpenAI, it's because Kern uses OpenAI models by default in several places, including:
