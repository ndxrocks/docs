...
This occurs because authorization is preferred over security key. Learn more about [security key](https://kern.ndx.rocks/agent-os/security/overview#security-key-authentication).
...
### For Newer Versions <Badge icon="code-branch" color="orange"><Tooltip tip="Introduced in v2.3.13" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.3.13">v2.3.13</Tooltip></Badge> and Later
...
<AccordionGroup>
  ...
  <Accordion title="Option 2: Switch to Authorization (Preferred)" defaultOpen={true}>
    ...
    3. **Ensure Authorization is enabled** on the AgentOS Control Plane and set the verification key. [More info](https://kern.ndx.rocks/agent-os/security/overview#switching-to-rbac)
...
- [JWT Authorization configuration](https://kern.ndx.rocks/agent-os/security/overview)
- [Migration to RBAC](https://kern.ndx.rocks/agent-os/security/overview#switching-to-rbac)
