...
- [Basic fallback example](https://github.com/kern-ai/kern/blob/main/cookbook/02_agents/17_fallback_models/01_basic_fallback.py)
- [Error-specific fallbacks example](https://github.com/kern-ai/kern/blob/main/cookbook/02_agents/17_fallback_models/02_error_specific_fallbacks.py)
- [Fallback callback example](https://github.com/kern-ai/kern/blob/main/cookbook/02_agents/17_fallback_models/04_fallback_callback.py)
- [Team fallback example](https://github.com/kern-ai/kern/blob/main/cookbook/03_teams/17_fallback_models/01_basic_fallback.py)
