...
2. **Cache Lookup**: Before making an API call, Kern checks if a cached response exists for that key
...
If not specified, Kern uses a default cache location of `~/.kern/cache/model_responses` in your home directory.
