...
description: Run local models with LlamaCpp in Kern agents.
---

<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.0.7" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.0.7">v2.0.7</Tooltip>
</Badge>
