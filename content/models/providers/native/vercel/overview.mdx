...
description: Use Vercel v0 models for web development with Kern agents.
---
...
Use `V0` with your `Agent`. The following example assumes you have the `V0` Python class (as you provided) located at `kern/models/vercel.py`.
