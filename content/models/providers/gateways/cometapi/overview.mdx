...
description: Use CometAPI models with Kern agents.
---

<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.0.8" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.0.8">v2.0.8</Tooltip>
</Badge>
