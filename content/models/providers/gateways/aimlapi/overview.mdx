...
description: Use AI/ML API with access to 300+ models in Kern agents.
---
...
Set your `AIMLAPI_API_KEY` environment variable. Get your key at [aimlapi.com](https://aimlapi.com/?utm_source=kern&utm_medium=github&utm_campaign=integration).
