...
description: Use Claude models through Vertex AI with Kern agents.
sidebarTitle: Claude
---

<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.1.3" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.1.3">v2.1.3</Tooltip>
</Badge>
