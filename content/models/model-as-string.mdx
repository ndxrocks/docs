...
Kern provides a convenient string syntax for specifying models using the `provider:model_id` format. This approach reduces code verbosity by eliminating the need to import model classes while maintaining full functionality.
