...
description: Generate files in different formats with Kern agents.
keywords: [file generation, document generation, pdf generation, file tools, create files]
mode: wide
---

Kern provides the [`FileGenerationTools`](/tools/toolkits/file-generation/file-generation) to generate files in different formats.
