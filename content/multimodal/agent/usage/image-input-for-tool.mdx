...
This example demonstrates how tools can receive and process images automatically through Kern's joint media access functionality. It shows initial image upload and analysis, DALL-E image generation within the same run, and cross-run media persistence.
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai openai psycopg
    ```
  </Step>
