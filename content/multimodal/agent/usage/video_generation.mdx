---
title: Video Output
description: Generate videos with AI tools in Kern agents.
keywords: [video generation, ai video, video tools, fal, replicate, video creation]
mode: wide
---

This example demonstrates how to generate a video using [FAL](https://fal.ai/video) in an Kern agent.
