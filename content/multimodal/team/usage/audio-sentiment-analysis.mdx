...
This example demonstrates how an Kern Agent Team can collaborate to perform sentiment analysis on audio conversations using transcription and sentiment analysis agents working together.
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        uv pip install kern-ai requests google-generativeai
        ```
    </Step>
