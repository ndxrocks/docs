...
description: "Demonstrates using Maxim to trace and log Kern agent and team calls."
---
```python
"""
Maxim Integration
...
Demonstrates using Maxim to trace and log Kern agent and team calls.
"""
...
try:
    ...
    from maxim.logger.kern import instrument_agno
except ImportError:
    raise ImportError(
...
# Setup
# ---------------------------------------------------------------------------
# Instrument Kern with Maxim for automatic tracing and logging
