...
description: "Demonstrates tracing a multi-step Kern workflow in Arize Phoenix."
---
```python
"""
...
Demonstrates tracing a multi-step Kern workflow in Arize Phoenix.
"""
...
export ARIZE_PHOENIX_API_KEY="***"
export PHOENIX_CLIENT_HEADERS="***"
