...
description: "Demonstrates Kern's two-table trace design and how to inspect traces and spans."
---
```python
"""
Trace To Database
...
Demonstrates Kern's two-table trace design and how to inspect traces and spans.
"""
...
def run_trace_demo() -> None:
    ...
    try:
        ...
        if not trace:
            print(
                "\n[ERROR] No trace found. Make sure openinference-instrumentation-kern is installed."
            )
        else:
            print("\n Found trace for run")
