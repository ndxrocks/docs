...
description: "This can significantly reduce processing time and costs."
---
This can significantly reduce processing time and costs. Use it when working with a static and large system prompt.
