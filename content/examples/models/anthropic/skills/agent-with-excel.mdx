...
description: "This cookbook demonstrates how to use Claude's xlsx skill to create Excel spreadsheets through Kern agents."
---
```python
"""
Kern Agent with Excel Skills.

This cookbook demonstrates how to use Claude's xlsx skill to create Excel
spreadsheets through Kern agents.
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Kern Agent with Excel Skills")
    print("=" * 60)
