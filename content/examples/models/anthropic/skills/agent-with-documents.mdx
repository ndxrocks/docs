...
description: "This cookbook demonstrates how to use Claude's docx skill to create Word documents through Kern agents."
---
```python
"""
Kern Agent with Word Document Skills.

This cookbook demonstrates how to use Claude's docx skill to create Word
documents through Kern agents.
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Kern Agent with Word Document Skills")
    print("=" * 60)
