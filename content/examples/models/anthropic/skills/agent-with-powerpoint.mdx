...
description: "This cookbook demonstrates how to use Claude's pptx skill to create PowerPoint presentations through Kern agents."
---
```python
"""
Kern Agent with PowerPoint Skills.

This cookbook demonstrates how to use Claude's pptx skill to create PowerPoint
presentations through Kern agents.

Prerequisites:
- uv pip install kern-ai anthropic
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Kern Agent with PowerPoint Skills")
    print("=" * 60)
...
cd kern/cookbook/90_models/anthropic/skills
