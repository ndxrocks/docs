...
description: "This cookbook demonstrates Claude's context management feature for automatic tool result clearing."
---
...
1. Install dependencies: `uv pip install -U kern-ai anthropic ddgs sqlalchemy`
