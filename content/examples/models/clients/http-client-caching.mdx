...
description: "Demonstrates how to define a single global `httpx.Client`."
---
Demonstrates how to define a single global `httpx.Client` so that all kern Agents (OpenAI, Anthropic, internal models, etc.) share consistent behavior: logging, headers, request IDs, and retries.
...
so that all kern Agents (OpenAI, Anthropic, internal models, etc.)
...
Install:
    uv pip install kern-ai openai httpx
"""
...
logger = logging.getLogger("kern.http")
...
cd kern/cookbook/90_models/clients
