---
title: "Groq Deep Knowledge"
sidebarTitle: "DeepKnowledge"
description: "This agent performs iterative searches through its knowledge base, breaking down complex."
---
...
Run `uv pip install openai lancedb tantivy inquirer kern-ai groq` to install dependencies.
"""
...
def initialize_knowledge_base():
    ...
    Here we use Kern docs as an example, but you can replace with any relevant URLs
    """
    ...
    agent_knowledge.insert(url="https://kern.ndx.rocks/llms-full.txt")
...
def get_example_topics() -> List[str]:
    ...
    return [
        "What are AI agents and how do they work in Kern?",
        "What chunking strategies does Kern support for text processing?",
        "How can I implement custom tools in Kern?",
        "How does knowledge retrieval work in Kern?",
        "What types of embeddings does Kern support?",
    ]
...
"""
Explore Kern's capabilities with these queries:
1. "What are the different types of agents in Kern?"
2. "How does Kern handle knowledge base management?"
3. "What embedding models does Kern support?"
4. "How can I implement custom tools in Kern?"
5. "What storage options are available for workflow caching?"
6. "How does Kern handle streaming responses?"
7. "What types of LLM providers does Kern support?"
