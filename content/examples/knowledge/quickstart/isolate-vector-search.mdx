---
title: "Demonstrates knowledge isolation with isolate_vector_search flag."
sidebarTitle: "Isolate Vector Search"
description: "When multiple Knowledge instances share the same vector database, you can use."
---
When multiple Knowledge instances share the same vector database, you can use the `isolate_vector_search` flag to ensure each instance only searches its own data.
...
python 17_isolate_vector_search.py
```
