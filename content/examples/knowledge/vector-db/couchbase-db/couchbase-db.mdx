...
description: "Setup Couchbase Cluster (Local via Docker) and run the Couchbase vector database example."
---
Setup Couchbase Cluster (Local via Docker): ------------------------------------------- 1. Run Couchbase locally:
...
from kern.vectordb.couchbase import CouchbaseSearch
...
cd kern/cookbook/07_knowledge/vector_db/couchbase_db
