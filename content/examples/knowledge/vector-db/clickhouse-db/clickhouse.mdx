...
description: "Demonstrates ClickHouse-backed knowledge with sync, async, and async-batching flows."
---
```python
"""
ClickHouse Database
...
from kern.vectordb.clickhouse import Clickhouse
...
cd kern/cookbook/07_knowledge/vector_db/clickhouse_db
