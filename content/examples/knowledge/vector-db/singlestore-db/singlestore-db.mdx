...
description: "Run setup script: `./cookbook/scripts/run_singlestore.sh`."
---
Run setup script: `./cookbook/scripts/run_singlestore.sh`
...
from kern.vectordb.singlestore import SingleStore
...
cd kern/cookbook/07_knowledge/vector_db/singlestore_db
