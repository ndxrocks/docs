...
description: "Demonstrates Cassandra-backed knowledge with sync, async, and async-batching flows."
---
```python
"""
Cassandra Database
...
async def run_async(session, enable_batch: bool = False) -> None:
    ...
    if enable_batch:
        ...
        await agent.aprint_response(
            "What is the purpose of an Kern Agent?", markdown=True
        )
...
cd kern/cookbook/07_knowledge/vector_db/cassandra_db
