...
description: "Install dependency: - uv pip install upstash-vector."
---
...
from kern.vectordb.upstashdb import UpstashVectorDb
...
def create_sync_knowledge() -> tuple[Knowledge, UpstashVectorDb]:
    ...
    knowledge = Knowledge(
        ...
        description="Kern 2.0 Knowledge Implementation with Upstash Vector DB",
        vector_db=vector_db,
    )
...
cd kern/cookbook/07_knowledge/vector_db/upstash_db
