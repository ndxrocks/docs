---
title: "Example demonstrating custom knowledge retriever with runtime dependencies."
sidebarTitle: "Retriever With Dependencies"
description: "This cookbook shows how to access dependencies passed at runtime (e.g., via `agent.run(dependencies={...})`)"
---
This cookbook shows how to access dependencies passed at runtime (e.g., via `agent.run(dependencies={...})`) in a custom knowledge retriever function.
...
cd kern/cookbook/07_knowledge/custom_retriever
