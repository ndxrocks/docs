...
description: "Demonstrates using FileSystemKnowledge to let an agent search local files."
---
```python
"""
...
# Create a filesystem knowledge base pointing to the kern library source
fs_knowledge = FileSystemKnowledge(
    base_dir="libs/kern/kern",
    include_patterns=["*.py"],
...
if __name__ == "__main__":
    ...
    agent = Agent(
        ...
        instructions=(
            "You are a code assistant that helps users explore the kern codebase. "
...
cd kern/cookbook/07_knowledge/protocol
