...
description: "This cookbook demonstrates how to configure multiple Knowledge instances in AgentOS, each with isolated content."
---
```python
"""
...
cd kern/cookbook/07_knowledge/os
