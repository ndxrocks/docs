...
description: "This example shows how to use persistent memory with an Agent."
---
This example shows how to use persistent memory with an Agent. After each run, user memories are created or updated.
