...
description: "This example shows how to create and apply a custom memory optimization strategy by subclassing MemoryOptimizationStrategy."
---
```python
"""
...
from kern.memory import MemoryManager, MemoryOptimizationStrategy
...
cd kern/cookbook/11_memory/optimize_memories
