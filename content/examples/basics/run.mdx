...
What is Agent OS?
-----------------
Agent OS is Kern's runtime that lets you:
...
2. Visit https://os.kern.ndx.rocks in your browser
...
Learn More
----------
- Agent OS Overview: https://kern.ndx.rocks/agent-os/overview
- Kern Documentation: https://kern.ndx.rocks
"""
