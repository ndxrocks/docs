...
description: "This example shows how to give an agent a searchable knowledge base."
---

This example shows how to give an agent a searchable knowledge base. The agent can search through documents (PDFs, text, URLs) to answer questions.
...
# ---------------------------------------------------------------------------
instructions = """\
You are an expert on the Kern framework and building AI agents.

## Workflow

1. Search
   - For questions about Kern, always search your knowledge base first
...
- Always search knowledge before answering Kern questions
...
if __name__ == "__main__":
    # Load the introduction from the Kern documentation into the knowledge base
    # We're only loading 1 file to keep this example simple.
    knowledge.insert(
        name="Kern Introduction", url="https://kern.ndx.rocks/introduction.md"
    )
