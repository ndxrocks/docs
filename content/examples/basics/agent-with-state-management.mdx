...
description: "This example shows how to give your agent persistent state that it can read and modify."
---

This example shows how to give your agent persistent state that it can read and modify. The agent maintains a stock watchlist across conversations.
