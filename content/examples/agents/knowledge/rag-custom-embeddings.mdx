...
description: "This cookbook is an implementation of Agentic RAG using Sentence Transformer Reranker with multilingual data."
---
```python
"""
...
from kern.knowledge.reranker.sentence_transformer import SentenceTransformerReranker
