---
title: "Example demonstrating background execution with polling and cancellation."
sidebarTitle: "Background Execution"
description: "Background execution allows you to start an agent run that returns immediately."
---
...
async def example_cancel_before_start():
    ...
    from kern.run.cancel import cancel_run
