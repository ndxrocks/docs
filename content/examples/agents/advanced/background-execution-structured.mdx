---
title: "Example demonstrating background execution with structured output."
sidebarTitle: "Background Execution Structured"
description: "Combines background execution (non-blocking, async) with Pydantic output_schema so the completed run returns typed, structured data."
---
```python
"""
