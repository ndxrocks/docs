...
| [Output Schema](/examples/agents/input-output/output-schema) | This example shows how to use the output_model parameter to specify the model that will be used to generate the final response. |
