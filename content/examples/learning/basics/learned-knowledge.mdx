...
description: "Learned Knowledge stores reusable insights that apply across users."
---
Learned Knowledge stores reusable insights that apply across users: - Best practices discovered through use - Domain-specific patterns - Solutions to common problems
...
cd kern/cookbook/08_learning/01_basics
