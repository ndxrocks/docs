---
title: "This example shows how to run an Agent using our MCP integration in the Kern OS."
sidebarTitle: "Mcp Demo"
description: "Run an agent with MCP tool integration in AgentOS."
---
For this example to run you need: - Create a GitHub personal access token following these steps: - https://github.com/modelcontextprotocol/servers/tree/main/src/github#setup - Set the GITHUB_TOKEN environment variable: `export GITHUB_TOKEN=<Your GitHub access token>` - Run: `uv pip install kern-ai mcp openai` to install the dependencies

```python
"""This example shows how to run an Agent using our MCP integration in the Kern OS.
...
- Run: `uv pip install kern-ai mcp openai` to install the dependencies
"""
