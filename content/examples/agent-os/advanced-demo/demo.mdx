...
from kern.db.postgres.postgres import PostgresDb  # noqa: F401
...
if __name__ == "__main__":
    ...
    # Setup knowledge
    # agno_assist.knowledge.insert(name="Kern Docs", url="https://kern.ndx.rocks/llms-full.txt", skip_if_exists=True)
