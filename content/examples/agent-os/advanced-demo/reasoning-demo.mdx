...
description: "Use LanceDB as the vector database and store embeddings in the `agno_docs` table."
---
```python
"""Run `uv pip install openai exa_py ddgs yfinance pypdf sqlalchemy 'fastapi[standard]' youtube-transcript-api python-docx kern-ai` to install dependencies."""
...
if __name__ == "__main__":
    agno_docs.insert(name="Kern Docs", url="https://www.paulgraham.com/read.html")
