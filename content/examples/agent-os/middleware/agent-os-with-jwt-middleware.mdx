---
title: "This example demonstrates how to use our JWT middleware with AgentOS."
sidebarTitle: "Agent Os With Jwt Middleware"
description: "The middleware extracts JWT claims and stores them in request.state for easy access."
---
