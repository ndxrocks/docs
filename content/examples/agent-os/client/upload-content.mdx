...
description: "This example demonstrates how to upload documents and content to the knowledge base using AgentOSClient."
---
```python
"""
...
async def upload_text_content():
    ...
    content = """
    # Kern Framework Guide
    
    Kern is a powerful framework for building AI agents and teams.
    ...
    ## Getting Started
    1. Install kern-ai: uv pip install kern-ai
    ...
    try:
        ...
        result = await client.upload_knowledge_content(
            ...
            name="Kern Guide",
            description="A guide to the Kern framework",
        )
