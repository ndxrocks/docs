...
description: "This example demonstrates how to execute agent runs using AgentOSClient, including both streaming and non-streaming responses."
---
```python
"""
...
async def run_agent_streaming():
    ...
    from kern.run.agent import RunCompletedEvent, RunContentEvent
