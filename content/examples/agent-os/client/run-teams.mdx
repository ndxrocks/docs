...
description: "This example demonstrates how to execute team runs using AgentOSClient, including both streaming and non-streaming responses."
---
```python
"""
...
async def run_team_streaming():
    ...
    from kern.run.team import RunCompletedEvent, RunContentEvent
