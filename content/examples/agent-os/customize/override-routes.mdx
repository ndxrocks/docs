...
description: "This example demonstrates the `on_route_conflict=\"preserve_base_app\"` functionality which allows your."
---
This example demonstrates the `on_route_conflict="preserve_base_app"` functionality which allows your custom routes to take precedence over conflicting AgentOS routes.
