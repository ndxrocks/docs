...
sidebarTitle: "Handle Custom Events"
description: "You can yield custom events from your own tools. These events will be handled internally as an Kern event, and you will be able to access it in the same way you would ..."
---
You can yield custom events from your own tools. These events will be handled internally as an Kern event, and you will be able to access it in the same way you would access any other Kern event.
...
async def get_customer_profile(run_context: RunContext):
    ...
    # We only need to yield the custom event, Kern will handle the rest.
