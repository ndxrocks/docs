...
description: "This example demonstrates cross-framework A2A communication: Kern client -> Google ADK server."
---
This example demonstrates cross-framework A2A communication: Kern client -> Google ADK server

```python
"""Connect Kern A2AClient to Google ADK A2A Server.

This example demonstrates cross-framework A2A communication:
Kern client -> Google ADK server

Prerequisites:
    1. Install dependencies:
       uv pip install kern-ai httpx google-adk uvicorn
...
cd kern/cookbook/05_agent_os/client_a2a
