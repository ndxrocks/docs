...
sidebarTitle: "Shopify Demo"
description: "Prerequisites: - Set the following environment variables: - SHOPIFY_SHOP_NAME -> Your Shopify shop name, e.g."
---
...
from kern.os.config import AgentOSConfig, ChatConfig
from kern.tools.shopify import ShopifyTools
...
cd kern/cookbook/05_agent_os/integrations
