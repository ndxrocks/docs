...
description: "This example demonstrates how to use background hooks with a Team."
---
This example demonstrates how to use background hooks with a Team. Background hooks execute after the API response is sent, making them non-blocking.
