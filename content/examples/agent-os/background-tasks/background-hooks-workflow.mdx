...
description: "This example demonstrates how to use background hooks with a Workflow."
---
This example demonstrates how to use background hooks with a Workflow. Background hooks execute after the API response is sent, making them non-blocking.
