...
description: "This example demonstrates how to define custom scope mappings for your AgentOS endpoints."
---
This example demonstrates how to define custom scope mappings for your AgentOS endpoints. You can specify exactly which scopes are required for each endpoint.
...
from kern.utils.cryptography import generate_rsa_keys
...
cd kern/cookbook/05_agent_os/rbac/asymmetric
