...
description: "This example demonstrates how to enable RBAC (Role-Based Access Control)"
---
This example demonstrates how to enable RBAC (Role-Based Access Control) with JWT token authentication using RS256 asymmetric keys.
