...
---
This example demonstrates how to enable RBAC (Role-Based Access Control) with JWT token authentication in AgentOS using middleware with cookie-based tokens.
...
from kern.os.middleware import JWTMiddleware, TokenSource
