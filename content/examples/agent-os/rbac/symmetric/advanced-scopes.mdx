---
title: "Symmetric Advanced Scopes"
sidebarTitle: "Advanced RBAC Example with AgentOS"
description: "This example demonstrates the AgentOS RBAC system with simplified scope format."
---
