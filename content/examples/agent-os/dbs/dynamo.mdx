...
sidebarTitle: "Dynamo"
description: "Use DynamoDB as the database backend for AgentOS."
---
Set the following environment variables to connect to your DynamoDb instance: - AWS_REGION - AWS_ACCESS_KEY_ID - AWS_SECRET_ACCESS_KEY
