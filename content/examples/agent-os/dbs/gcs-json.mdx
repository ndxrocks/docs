---
title: "Example showing how to use AgentOS with JSON files hosted in GCS as database."
sidebarTitle: "Gcs Json"
description: "Use Google Cloud Storage JSON as the database backend for AgentOS."
---
