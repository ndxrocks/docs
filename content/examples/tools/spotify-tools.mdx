---
title: "Spotify"
description: "Use SpotifyTools with Kern agents."
---
Enable Kern agents with Spotify tool to: 
...
from kern.tools.spotify import SpotifyTools
...
```
For details, see [SpotifyTools](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/spotify_tools.py). 