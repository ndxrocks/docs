---
title: "Mem0"
description: "Use Mem0 tool with Kern agents."
---

Enable Kern agents to remember user preferences, past interactions, and specific facts across different conversations and platforms with Mem0.
...
from kern.tools.mem0 import Mem0Tools
...
```
For details, see [Mem0 tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/mem0_tools.py).