---
title: "Websearch"
description: "Enable Websearch tools with Kern agents."
---

Enable Kern agents with Websearch tools for a unified, multi-backend interface that allows agents to autonomously gather real-time data from any major search engine.
...
```
For details, see [Websearch cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/websearch_tools.py).