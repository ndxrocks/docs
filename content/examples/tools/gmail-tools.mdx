---
title: "Gmail"
description: "Use Gmail with Kern agents."
---
Enable Kern agents to read, draft, and send emails using the Gmail API.

```python

from kern.agent import Agent
from kern.models.openai import OpenAIChat
from kern.tools.gmail import GmailTools
...
```
For details, see [Gmail cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/gmail_tools.py).