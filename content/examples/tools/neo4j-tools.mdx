...
from kern.tools.neo4j import Neo4jTools
...
For details, see [Neo4j cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/neo4j_tools.py).