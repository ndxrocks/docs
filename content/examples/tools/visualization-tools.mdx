...
description: "Use visualization with Kern agents."
---
Enable Kern agents to create various types of charts and graphs for data visualization. Use `include_tools/exclude_tools` patterns for selective visualization function access.
...
from kern.tools.visualization import VisualizationTools
...
```
For details, see [Visualization tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/visualization_tools.py).