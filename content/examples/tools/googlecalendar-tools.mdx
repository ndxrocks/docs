...
description: "Use Google Calendar with Kern agents."
---

Enable Kern agents the "executive assistance" capability to move beyond just reading emails or chat to actively managing your time, coordinating with teams, and resolving scheduling conflicts autonomously with Google Calendar.
...
For details, see [Google Calendar cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/googlecalendar_tools.py).