---
title: "Apify"
description: "Use Apify tools with Kern Agents for data extraction."
---

## Prerequisites

1. Install required dependencies:
   `uv pip install kern-ai langchain-apify apify-client`
...
def demonstrate_tools():
    ...
    prompt = "Carefully extract the key introduction details from https://kern.ndx.rocks/introduction"  #  Extract content from specific website
...
```
For details, see [Apify cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/apify_tools.py).