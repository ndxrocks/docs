...
description: "Use MLX Trascribe tool with Kern agents."
---

MLX Transcribe tool enables Kern agents to generate audio files using MLX Whisper.
...
from kern.tools.mlx_transcribe import MLXTranscribeTools
...
```
For details, see [MLX Transcribe tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/mlx_transcribe_tools.py).