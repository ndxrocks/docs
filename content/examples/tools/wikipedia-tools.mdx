...
---
Enable Kern agents to perform high-speed searches and retrieve detailed information from Wikipedia to ground their answers in factual, verified data.
...
```
For details, see [Wikipedia tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/wikipedia_tools.py).