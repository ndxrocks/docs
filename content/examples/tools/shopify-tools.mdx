---
title: "Shopify"
description: "Use Shopify tools with an Kern Agent."
---
Enable Kern agents with Shopify tools to:
...
```
For details, see [Shopify tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/shopify_tools.py).