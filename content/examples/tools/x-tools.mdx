---
title: "X"
description: "Use X with Kern agents."
---
...
from kern.tools.x import XTools
...
python x_tools.py
```
For details, see [X tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/x_tools.py).