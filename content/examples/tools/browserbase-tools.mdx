---
title: "Browserbase"
description: "Use Browserbase Tools with Kern Agents."
---

If you’re building agentic workflows with Kern Agents that need to interact with websites, fill out forms, or replicate user's actions, use Browserbase. It can manage that infrastructure so you don’t have to maintain your own fleet of headless browsers.
...
from kern.tools.browserbase import BrowserbaseTools
...
```
For details, see [Browserbase cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/browserbase_tools.py).