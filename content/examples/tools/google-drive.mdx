---
title: "Google Drive"
description: "Use Google Drive with Kern agents."
---

Enable Kern agents to read, create, update and duplicate Google Drive files.
...
from kern.tools.google_drive import GoogleDriveTools
...
```
For details, see [Google Drive cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/google_drive_tools.py).
