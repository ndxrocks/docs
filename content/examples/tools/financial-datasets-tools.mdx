...
description: "Use financial datasets with Kern agents"
---

Enable Kern agents with various Financial Datasets API functionalities including analyzing financial statements, stock prices, news, insider trades, and more.
...
from kern.tools.financial_datasets import FinancialDatasetsTools
...
```
For details, see [Financial Dataset Tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/financial_datasets_tools.py).