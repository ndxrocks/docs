---
title: "Docker"
description: "Use Docker with Kern agents."
---

Enable code sandbox layer in Kern agents with Docker. Integration with Docker allows an agent to go from just thinking about code to safely executing it in a controlled, isolated environment.
...
if __name__ == "__main__":
    try:
        from kern.tools.docker import DockerTools
...
For details, see [Docker cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/docker_tools.py).