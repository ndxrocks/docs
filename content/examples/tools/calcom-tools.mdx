---
title: "Cal.com"
description: "Use Calcom scheduling with Kern Agents."
---

Enable Kern agents to use [Calcom](https://github.com/calcom/cal.com) tool for calendaring and scheduling functions.
...
from kern.tools.calcom import CalComTools
...
```
For details, see [Cal.com cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/calcom_tools.py).