---
title: "Unsplash"
description: "Use Unsplash tools with Kern agents."
---
Enable Kern agents to search for and retrieve high-quality, royalty-free images from Unsplash.
...
3. Install dependencies: `pip install openai kern-ai`
...
```
For details, see [Unsplash tool cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/unsplash_tools.py).