---
title: "Notion"
description: "Use Notion tools with Kern agents."
---

Enable Kern agents to organize and manage content in Notion.

## Prerequisites


<Expandable title="How to set up and configure Notion client?">
   1. Install required dependencies:
      uv pip install kern-ai notion-client

   2. Create a Notion Integration:
      - Go to https://www.notion.so/my-integrations
      - Click "+ New integration"
      - Name it (e.g., "Kern Agent")
...
```
For details, see [Notion cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/notion_tools.py).