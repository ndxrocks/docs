---
title: "YFinance"
description: "Use YFinance tools with Kern agents."
---
Enable Kern agents to plug in YFinanceTools for financial analysis. For selective function access, use `include_tools/exclude_tools` patterns.
...
```
For details, see [YFinance tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/yfinance_tools.py).