---
title: "Salesforce"
description: "Use Salesforce CRM with Kern agents to query, create, and manage records."
---
...
from kern.tools.salesforce import SalesforceTools
...
For details, see [Salesforce Tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/salesforce_tools.py).
