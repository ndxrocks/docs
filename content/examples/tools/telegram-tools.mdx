---
title: "Telegram"
description: "Use Telegram tools with Kern agents."
---
Enable Kern agents to perform Telegram bot operations. 
...
```
For details, see [Telegram tool cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/telegram_tools.py).