---
title: "Zoom"
description: "Use Zoom tools with an Kern agents."
---
Enable Kern agents with Zoom and allow them to: 
...
from kern.tools.zoom import ZoomTools
...
```
For details, see [Zoom tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/zoom_tools.py).