...
description: "Use Pre and Post Hooks in Kern agents."
---

Enable granular control in Kern agents as they interact with external tools and APIs. Intercept tool execution before and after calls to log data or modify results.
...
```
For details, see [Agent Execution Hooks cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/tool_hooks/pre_and_post_hooks.py).