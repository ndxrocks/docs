...
description: "Use of multiple hooks for complex validation and result sanitization."
---

Execute multiple hooks in a specific order to implement sequential validation, logging, and result sanitization for both synchronous and asynchronous AI tools.
...
```
For details, see [Chained Toolkit Hooks cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/tool_hooks/tool_hooks_in_toolkit_nested.py).