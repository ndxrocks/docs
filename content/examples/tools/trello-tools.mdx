---
title: "Trello"
description: "Use Trello tool with Kern agents."
---

Enable Kern agents to interact with Trello's API to manage boards, lists, and cards, effectively turning your agent into an autonomous project manager that can organize team tasks, track deadlines, and update progress reports.
...
from kern.tools.trello import TrelloTools
...
```
For details, see [Trello tool cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/trello_tools.py).