---
title: "Trafilatura"
description: "Use Trafilatura tools with Kern agents."
---
Enable Kern agents for web scraping and text extraction with TrafilaturaTools. They provides capabilities for extracting clean, readable text from web pages and converting raw HTML into structured, meaningful data.
...
from kern.tools.trafilatura import TrafilaturaTools
...
def basic_text_extraction():
    ...
    agent.print_response(
        "Please extract and summarize the main content from https://github.com/kern-ai/kern"
    )
...
```
For details, see [Trafilatura tool cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/trafilatura_tools.py).