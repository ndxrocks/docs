---
title: "Daytona"
description: "Use Dayton with Kern agents."
---

Daytona enables Kern agents to run Agent-generated code in a remote, secure sandbox.
...
3. Install the dependencies:
    `uv pip install kern-ai anthropic daytona`

```python

from kern.agent import Agent
from kern.tools.daytona import DaytonaTools
...
For details, see [Daytona cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/daytona_tools.py).