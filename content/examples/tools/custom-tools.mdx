---
title: "Custom Tools"
description: "Use custom tools with Kern agents."
---

Build agentic workflows with Kern agents and extend their functionality through the use of custom tools.
...
```
For details, see [Custom tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/custom_tools.py).