---
Title: "Pandas"
description: "Use Pandas with Kern agents."
---

Enable Kern agents for data manipulation and analysis.
...
from kern.tools.pandas import PandasTools
...
```
For details, see [Pandas cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/pandas_tools.py).