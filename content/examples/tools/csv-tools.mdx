---
title: "CSV"
description: "Use CSV Tools with Kern agents."
---

- Data Analysis and Processing for CSV Files

Enable Kern agents to use CSV Tools for data analysis and processing CSV files. Use `enable_` flag patterns for selective function access.
...
from kern.tools.csv_toolkit import CsvTools
...
python csv_tools.py
```
For details, see [csv-tools cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/csv_tools.py).