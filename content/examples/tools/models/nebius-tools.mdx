---
title: "Nebius"
description: "Use Nebius for image generation with Kern agents."
---
...
from kern.tools.models.nebius import NebiusTools
...
```
For details, see [Morph cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/models/morph.py).