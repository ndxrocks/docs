---
title: "Azure OpenaAI"
description: "Use Azure OpenAI tools in Kern agents."
---
...
from kern.tools.models.azure_openai import AzureOpenAITools
...
```
For details, see [Azure OpenAI cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/models/azure_openai_tools.py).