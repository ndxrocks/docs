---
title: "Valyu"
description: "Use Valyu with Kern agents."
---

Enables Kern agents to get specialized access to academic, institutional, and high-fidelity web content for technical and scientific research.
...
from kern.tools.valyu import ValyuTools
...
```
For details, see [Valyu tool cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/valyu_tools.py).