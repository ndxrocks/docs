---
title: "Webex"
description: "Use Webex with Kern agents."
---

Enable Kern agents to autonomously manage Webex spaces and messaging to streamline enterprise communication and workflow automation.
...
from kern.tools.webex import WebexTools
...
```
For details, see [Webex cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/webex_tools.py).