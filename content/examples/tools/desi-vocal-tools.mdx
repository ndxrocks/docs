---
title: "Desi Vocal"
description: "Use Desi vocal tool with Kern agents."
---

Generate text-to-speech using Kern agents integrated with Desivocal, that specializing in high-quality, multilingual text-to-speech (TTS) and voice cloning, with a particular emphasis on Indian and Western languages.
...
from kern.tools.desi_vocal import DesiVocalTools
...
For details, see [Desi vocal cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/desi_vocal_tools.py).