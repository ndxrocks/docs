...
description: "This example shows how to use Pipedream MCP servers (in this case the Slack one) with Kern Agents."
---
```python
"""
Pipedream Slack MCP

This example shows how to use Pipedream MCP servers (in this case the Slack one) with Kern Agents.
...
4. Install dependencies: uv pip install kern-ai mcp
...
from kern.utils.log import log_exception
...
if __name__ == "__main__":
    ...
    asyncio.run(
        run_agent("Send a message to <YOUR_NAME> saying 'Hello, I'm your Kern Agent!'")
    )
```
