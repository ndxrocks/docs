...
description: "This example shows how to use Pipedream MCP servers (in this case the LinkedIn one) with Kern Agents."
---
```python
"""
 Pipedream LinkedIn MCP

This example shows how to use Pipedream MCP servers (in this case the LinkedIn one) with Kern Agents.
