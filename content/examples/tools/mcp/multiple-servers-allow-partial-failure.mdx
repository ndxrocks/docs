...
description: "Connecting to MCP servers that are not always available or prone to failure."
---
This is useful if you are connecting to MCP servers that are not always available or prone to failure, but don't want to stop the execution if some of the servers fail to connect.
