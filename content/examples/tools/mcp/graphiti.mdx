...
description: "This example demonstrates how to use Kern's MCP integration together with Graphiti, to build a personal diary assistant."
---
```python
"""
 MCP Graphiti Agent - A personal diary assistant

This example demonstrates how to use Kern's MCP integration together with Graphiti, to build a personal diary assistant.
...
if __name__ == "__main__":
    asyncio.run(
        ...
        run_agent(
            "Add the following entry to the diary: 'Today I spent some time building agents with Kern'"
        )
    )
