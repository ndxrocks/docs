...
description: "Use Kern's agent to create a Hacker News content using the Stagehand MCP server."
---
```python
"""
 Stagehand MCP Agent - Hacker News Reader's Digest

This example demonstrates how to use Kern's agent to create a Hacker News content using the Stagehand MCP server.
...
- Install dependencies: uv pip install kern-ai mcp
