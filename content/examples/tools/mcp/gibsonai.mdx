...
description: "This example shows how to connect a local GibsonAI MCP to Kern agent."
---
This example shows how to connect a local GibsonAI MCP to Kern agent.
...
3. Install the required dependencies:
    ```bash
    uv pip install kern-ai mcp openai
    ```
