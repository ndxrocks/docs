---
title: "Mem0 MCP"
description: "This example demonstrates how to use Kern's MCP integration together with Mem0, to build a personalized code reviewer."
---
```python
"""
‍ Mem0 MCP - Personalized Code Reviewer

This example demonstrates how to use Kern's MCP integration together with Mem0, to build a personalized code reviewer.

- Run your Mem0 MCP server. Full instructions: https://github.com/mem0ai/mem0-mcp
- Run: `uv pip install kern-ai mcp` to install the dependencies
"""
