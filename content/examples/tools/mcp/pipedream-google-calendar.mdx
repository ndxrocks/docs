...
description: "Use Pipedream MCP servers (in this case the Google Calendar one) with Kern Agents."
---
```python
"""
Pipedream Google Calendar MCP

This example shows how to use Pipedream MCP servers (in this case the Google Calendar one) with Kern Agents.
