---
title: "Lumalabs"
description: "Use Lumalabs tools with Kern agents."
---

Lumalabs tools enable Kern agents in generating high-quality, cinematic videos based on natural language prompts or reference images.
...
```
For details, see [Lumalabs cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/lumalabs_tools.py).