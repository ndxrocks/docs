---
title: "Crawl4AI"
description: "Use Crawl4AI with Kern agents."
---

Kern agents can use for web scraping and content extraction. For selective function access, it uses `enable_` flag patterns.
...
if __name__ == "__main__":
    ...
    agent_full.print_response(
        "Give me a detailed summary of the Kern project from https://github.com/kern-ai/kern and what are its main features?"
    )
...
```
For details, see [Crawl4ai cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/crawl4ai_tools.py).