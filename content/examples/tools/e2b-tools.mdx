---
title: "E2B"
description: "Use E2B tools with Kern agents."
---

Enable Kern agents with E2B tools to provide secure, long-running cloud sandboxes for executing untrusted code and processing complex data analysis and visualization workflows.
...
python e2b_tools.py
```
For details, see [E2B cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/e2b_tools.py).