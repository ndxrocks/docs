---
title: "Airflow"
description: "Use Airflow Tools with an Kern Agent."
---

Enable Kern agent with AIrflow tools for DAG management and workflow automation.
The example below uses enable_ flag patterns for selective function access.
...
from kern.tools.airflow import AirflowTools
...
```
For details, see [Airflow cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/airflow_tools.py).