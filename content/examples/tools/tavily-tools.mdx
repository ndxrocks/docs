---
title: "Tavily"
description: "Use Tavily tools with Kern agents."
---

Integrating Tavily into Kern transforms your app from a "chatbot" into a "knowledge engine" that can autonomously navigate the web, extract facts, and maintain real-time accuracy with enterprise-grade reliability.
...
For details, see [Tavily cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/tavily_tools.py).