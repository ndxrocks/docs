---
title: A2A
description: Expose Kern agents via the A2A protocol
---

<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.1.2" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.1.2">v2.1.2</Tooltip>
</Badge>
...
Kern integrates with A2A, enabling Kern agents and teams to be exposed in an A2A-compatible format.
...
agent = Agent(name="My Kern Agent",id="my_agent")
...
To use your Kern A2A interface with those clients, simply use `/a2a/agents/{id}/` (or `/a2a/teams/{id}/`, `/a2a/workflows/{id}/`) as the base url.
</Note>

## Connecting to A2A Servers

Kern provides two ways to connect to A2A-compatible servers:
