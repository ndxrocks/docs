...
# Add Kern JWT middleware to your custom FastAPI app
app.add_middleware(
    JWTMiddleware,
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai openai pyjwt "fastapi[standard]" uvicorn sqlalchemy pgvector psycopg python-multipart
    ```
  </Step>
