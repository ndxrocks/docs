...
<Note>
For a comprehensive introduction to Kern Tracing concepts (traces, spans, and what gets captured), see the [Tracing Overview](/tracing/overview).
</Note>

This guide covers how to configure tracing in AgentOS based on your database setup.

After running your agent/team, you can **view the traces** in the [AgentOS UI](https://os.kern.ndx.rocks/traces).
...
db = SqliteDb(db_file="tmp/kern.db")
