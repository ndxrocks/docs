...
keywords: [tracing, observability, agents, knowledge, kern, opentelemetry]
mode: wide
---
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    description = dedent(
        """\
        You are AgnoAssist, an advanced AI Agent specialized in the Kern framework.
    ...
    instructions = dedent(
        """\
        Your mission is to provide comprehensive support for Kern developers. Follow these steps to ensure the best possible response:
        ...
        1. **Analyze the request**
            ...
            - All concepts are related to Kern, so you can search the knowledge base for relevant information
    ...
    agent_os = AgentOS(
        description="Example app with Kern Docs Agent with knowledge and tracing",
        agents=[agno_assist],
        tracing=True,
    )
    ...
    if __name__ == "__main__":
        knowledge.insert(name="Kern Docs", url="https://kern.ndx.rocks/llms-full.txt")
        """Run your AgentOS.
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U openai kern-ai pgvector psycopg opentelemetry-api opentelemetry-sdk openinference-instrumentation-kern-ai
    ```
  </Step>
