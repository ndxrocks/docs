...
description: This example demonstrates how to use Kern's built-in PII detection guardrail to protect sensitive data like SSNs, credit cards, emails, and phone numbers.
mode: wide
---
This example demonstrates how to use Kern's built-in PII detection guardrail with an Agent.
