...
description: This example demonstrates how to use Kern's built-in OpenAI moderation guardrail to detect and block content that violates OpenAI's content policy.
mode: wide
---
This example demonstrates how to use Kern's built-in OpenAI moderation guardrail with an Agent.
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    from kern.guardrails import OpenAIModerationGuardrail
    ...
    async def main():
        ...
        try:
            unsafe_image = Image(
                url="https://kern-public.s3.amazonaws.com/images/ww2_violence.jpg"
            )
