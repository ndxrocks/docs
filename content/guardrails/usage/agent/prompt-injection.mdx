...
description: This example demonstrates how to use Kern's built-in prompt injection guardrail to detect and stop prompt injection and jailbreak attempts.
mode: wide
---
