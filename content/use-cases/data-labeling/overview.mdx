...
Kern is natively multimodal and type-safe, so the full labeling stack can be built in pure python.
...
If you're looking to jump straight into code - the [data labeling cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/data_labeling) contains 40+ runnable recipes across 18 data labeling patterns.
...
We use `gemini-3.5-flash` across the cookbooks because it handles text, image, audio, video, and PDF. Kern is model-agnostic, so you can swap models as needed.
...
- [Data labeling cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/data_labeling)
