...
|----------|--------|----------|-----------------------|
| Image | `from kern.media import Image` | `images=[Image(url=...)]` | `Gemini(id="gemini-3.5-flash")` |
| Audio | `from kern.media import Audio` | `audio=[Audio(content=...)]` | `Gemini(id="gemini-3.5-flash")` |
| Video | `from kern.media import Video` | `videos=[Video(content=..., format="mp4")]` | `Gemini(id="gemini-3.5-flash")` |
| PDF | `from kern.media import File` | `files=[File(url=...)]` | `Gemini(id="gemini-3.5-flash")` |
...
- [Image cookbooks](https://github.com/kern-ai/kern/tree/main/cookbook/data_labeling/_07_image_extraction)
- [Audio cookbooks](https://github.com/kern-ai/kern/tree/main/cookbook/data_labeling/_11_audio_transcription)
