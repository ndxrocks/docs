...
Each `(prompt, A, B, winner)` row is the input format for reward-model training and DPO. Kern produces the row; the trainer is out of scope.
...
- [Pairwise preference cookbook](https://github.com/kern-ai/kern/tree/main/cookbook/data_labeling/_05_text_pairwise_preference)
