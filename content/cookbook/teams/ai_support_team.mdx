...
customer_support_team.print_response(
    "Hi Team, I want to build an educational platform where the models are have access to tons of study materials, How can Kern platform help me build this?",
    stream=True,
)
# customer_support_team.print_response(
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai openai ddgs slack-sdk exa-py pgvector psycopg
    ```
  </Step>
