...
social_media_agent = Agent(
    ...
    • Competitors referenced, sentiment vs. Kern
...
social_media_agent.print_response(
    "Analyze the sentiment of Kern and AgnoAGI on X (Twitter) for past 10 tweets"
)
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai openai tweepy
    ```
  </Step>
