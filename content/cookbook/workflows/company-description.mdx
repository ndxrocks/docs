...
```
uv pip install kern-ai openai firecrawl-py resend
```
...
if __name__ == "__main__":
    supplier_profile_request = SupplierProfile(
        supplier_name="Kern",
        supplier_homepage_url="https://www.kern.ndx.rocks",
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai openai fastapi firecrawl-py resend markdown ddgs
    ```
  </Step>
