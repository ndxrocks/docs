...
email_writer_agent = Agent(
    ...
    instructions=[
        ...
        "Sign emails as 'John Doe, Senior Software Engineer' with email john@kern.ndx.rocks",
    ],
    ...
    asyncio.run(
        recruitment_workflow.aprint_response(
            ...
            candidate_resume_urls=[
                "https://kern-public.s3.us-east-1.amazonaws.com/demo_data/filters/cv_1.pdf",
                "https://kern-public.s3.us-east-1.amazonaws.com/demo_data/filters/cv_2.pdf",
            ],
            job_description="""
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U kern-ai openai fastapi pypdf requests
    ```
  </Step>
