...
The Demo OS contains a [Scheduler agent](https://github.com/kern-agi/demo-os/blob/main/agents/scheduler/agent.py) that does this.
...
```python
from kern.workflow import Workflow, Step, Parallel, Loop, Router, Condition
