...
description: "This example shows how to add authorization when integrating Pipedream MCP servers with Kern Agents."
---
...
3. Install dependencies: uv pip install kern-ai mcp-sdk
"""
