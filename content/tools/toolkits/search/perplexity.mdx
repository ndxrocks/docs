...
from kern.tools.perplexity import PerplexitySearch
...
- View [Example](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/perplexity_tools.py)
- [PerplexitySearch source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/perplexity.py)
