...
agent.print_response("Search web page: 'https://kern.ndx.rocks/introduction'", markdown=True)
```
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/website.py)
