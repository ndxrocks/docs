...
The only external library needed for spotify is the `httpx`. Which is already a dependency of Kern.
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/spotify.py)
