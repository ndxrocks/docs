...
The [`googleslides_tools.py`](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/googleslides_tools.py) cookbook demonstrates 8 scenarios:
...
- [Source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/google/slides.py)
- [Cookbook](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/googleslides_tools.py)
