...
For more examples, see the [Financial Datasets Examples](https://github.com/kern-ai/kern/tree/main/cookbook/91_models/others/financial_datasets).
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/financial_datasets.py)
