...
```shell
uv pip install "kern-ai[scheduler]"
```
...
- [Tools source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/scheduler.py)
- [Cookbook example](https://github.com/kern-ai/kern/blob/main/cookbook/05_agent_os/scheduler/scheduler_tools_agent.py)
