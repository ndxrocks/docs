...
<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.2.6" cta="View release notes" href="https://github.com/kern-ai/kern/releases/tag/v2.2.6">v2.2.6</Tooltip>
</Badge>

Notion is a powerful workspace management tool that allows you to create, organize, and collaborate on your work.

Kern provides tools for interacting with Notion databases to help you automate your workflows and streamline your work.
...
3. Fill in the details:
   - **Name**: Give it a name like "Kern Query Classifier"
...
4. Search for your integration name (e.g., "Kern Query Classifier")
...
from kern.tools.notion import NotionTools
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/notion.py)
