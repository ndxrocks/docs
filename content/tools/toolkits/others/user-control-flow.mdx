...
- View [Tools Source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/user_control_flow.py)
- [Kern Interactive Agents](https://kern.ndx.rocks/interactive-agents)
- [User Input Patterns](https://kern.ndx.rocks/user-input)
