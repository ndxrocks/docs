---
title: Trello
description: Kern TrelloTools helps to integrate Trello functionalities into your agents, enabling management of boards, lists, and cards.
---
...
- View [Tools Source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/trello.py)
