...
description: Kern MoviePyVideoTools enable an Agent to process videos, extract audio, generate SRT caption files, and embed rich, word-highlighted captions.
---
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/moviepy_video.py)
