...
The kern cookbook includes several Google Calendar examples demonstrating different use cases:
...
- [Source Code](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/google/calendar.py)
- [Cookbook Examples](https://github.com/kern-ai/kern/tree/main/cookbook/91_tools/google)
