...
from kern.tools.docling import DoclingTools
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/docling.py)
- [Cookbook Examples](https://github.com/kern-ai/kern/tree/main/cookbook/91_tools/docling_tools)
