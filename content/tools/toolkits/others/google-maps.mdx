...
For more examples, see the [Google Maps Tools Examples](https://github.com/kern-ai/kern/tree/main/cookbook/91_models/others/google_maps).
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/google_maps.py)
