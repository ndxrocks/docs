...
from kern.tools.llms_txt import LLMsTxtTools
...
agent.print_response(
    "Using the llms.txt at https://kern.ndx.rocks/llms.txt, "
...
- [Tools source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/llms_txt.py)
- [Agentic mode example](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/llms_txt_tools.py)
- [Knowledge mode example](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/llms_txt_tools_knowledge.py)
