...
agent = Agent(
    tools=[DuckDbTools()],
    system_message="Use this file for Movies data: https://kern-public.s3.amazonaws.com/demo_data/IMDB-Movie-Data.csv",
)
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/duckdb.py)
