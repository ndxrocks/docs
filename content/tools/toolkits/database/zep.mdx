...
zep_tools = ZepTools(user_id="kern", session_id="kern-session", add_instructions=True)
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/zep.py)
