...
<Note> View more examples [here](https://github.com/kern-ai/kern/tree/main/cookbook/91_models/models/openai). </Note>
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/openai.py)
