...
audio_url = "https://kern-public.s3.amazonaws.com/demo_data/sample_conversation.wav"
...
- View [Tools](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/models/groq.py)
- View [Transcription Example](https://github.com/kern-ai/kern/tree/main/cookbook/11_models/groq/transcription_agent.py)
- View [Translation Example](https://github.com/kern-ai/kern/tree/main/cookbook/11_models/groq/translation_agent.py)
