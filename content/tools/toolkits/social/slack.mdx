...
```shell
uv pip install -U "kern-ai[slack]"
```
...
agent.print_response("Send a message 'Hello from Kern!' to the channel #general", markdown=True)
...
<CardGroup cols={2}>
  ...
  <Card title="Source Code" icon="github" href="https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/slack.py">
