...
The kern cookbook includes several Gmail examples demonstrating different use cases:
...
- [Source Code](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/google/gmail.py)
