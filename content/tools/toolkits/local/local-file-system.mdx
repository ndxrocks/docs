...
from kern.tools.local_file_system import LocalFileSystemTools
...
- View [Tools Source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/local_file_system.py)
