...
See [Workspace with confirmation](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py) for the full pause/resume example, and [User Confirmation](/hitl/user-confirmation) for the HITL pattern.

## Developer Resources

- [Tools source](https://github.com/kern-ai/kern/blob/main/libs/kern/kern/tools/workspace.py)
- [Basic usage](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/workspace_tools/basic_usage.py)
- [With confirmation](https://github.com/kern-ai/kern/blob/main/cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py)
